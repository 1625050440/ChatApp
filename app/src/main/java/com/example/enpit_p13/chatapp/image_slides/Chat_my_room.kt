...
import java.util.*
class Chat_my_room : AppCompatActivity() {

    var imageModelArrayList: ArrayList<ImageModel>? = null

    val myImageList: IntArray = intArrayOf(R.drawable.myroom1,R.drawable.myroom2,R.drawable.myroom3,R.drawable.myroom4,R.drawable.myroom5)
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_chat_my_room)
                    ...
                    override fun onDataChange(p0: DataSnapshot) {
                        p0.children.forEach {
                            ...
                            if(data?.uid.toString() == FirebaseAuth.getInstance().uid.toString()){
                                ...
                                reference.setValue(Check_online("Chat_my_room",data?.username.toString(),false))
    ...
    private fun init() {
        ...
        mPager = findViewById(R.id.pager_myroom) as ViewPager
        mPager!!.adapter = SlidingImage_Adapter(this@Chat_my_room, this.imageModelArrayList!!)
